...
namespace Geckout
{
    public partial class GameMap : SingletonMono<GameMap>
    {
        ...
        private void PlaceWall(GameTile prefab, Vector2Int c, float cellSize, float cubeSize, Vector3 centerOffset, string name, Vector3 localRotation, Vector3 dir)
        {
            ...
            //if (dir == Vector3.left)
            //{
            //    GameMap.TryGetTileAtCoord(c + Vector2Int.left, out var tileLeft);
