...
namespace Dreamteck.Splines.Editor
{
    ...
    [CustomEditor(typeof(BodyVisualRenderer))]
    [CanEditMultipleObjects]
    public class BodyVisualRendererEditor : MeshGenEditor
    {

        protected override void BodyGUI()
        {
            base.BodyGUI();
            BodyVisualRenderer tubeGenerator = (BodyVisualRenderer)target;
            ...
            if (capMode.intValue == (int)BodyVisualRenderer.CapMethod.Round)
            {
